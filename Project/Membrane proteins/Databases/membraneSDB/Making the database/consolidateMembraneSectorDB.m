...
% 06/06/14 - Maeva
% The script has been moved for clarity in the tree of folders.
% The file paths have to be updated before running again.
...
% Remove undefined sectors from polymer pdb records:
...
% Save the database
save('membraneSectorDB_053014_forCoord.mat', 'membraneSectorDB'); 
