...
%% Modified version of blast2msa that checks for existing raw and aligned
% MSA in the working directory and only sends the blast request to ncbi 
% if no file is found.
...
% Check for raw and aligned MSA before querying ncbi with a 
% blast request !
